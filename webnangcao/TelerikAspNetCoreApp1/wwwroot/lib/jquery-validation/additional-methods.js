 ...
 *
 *	<input class="userinfo" name="partnumber">
 *	<input class="userinfo" name="description">
 *
 *	...will validate unless at least one of them is filled.
 *
 * partnumber:	{require_from_group: [1,".userinfo"]},
 * description: {require_from_group: [1,".userinfo"]}
 *
 ...
 *	<input class="userinfo" name="partnumber">
 *	<input class="userinfo" name="description">
 *	<input class="userinfo" name="color">
 *
 *	...will validate unless either at least two of them are filled,
 *	OR none of them are.
 *
 * partnumber:	{skip_or_fill_minimum: [2,".userinfo"]},
 * description: {skip_or_fill_minimum: [2,".userinfo"]},
 * color:		{skip_or_fill_minimum: [2,".userinfo"]}
 *
 * options[0]: number of fields that must be filled in the group
 * options[1]: CSS selector that defines the group of conditionally required fields
 *
